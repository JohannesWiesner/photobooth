...
def floyd_steinberg_dither(image_file):
    ...
    for y in range(1, y_lim):
        for x in range(1, x_lim):
            ...
            print("i'm working",x,y)



    new_img.save("C:/Users/johwi/Coding/photobooth/hannes_dithered.png")

floyd_steinberg_dither("C:/Users/johwi/Coding/photobooth/hannes.png")